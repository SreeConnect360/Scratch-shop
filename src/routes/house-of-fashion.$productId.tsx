...
export const Route = createFileRoute("/house-of-fashion/$productId")({
  loader: ({ params }) => {
    ...
    <PublicLayout>
      <div className="min-h-[60vh] flex items-center justify-center text-center">
        <div>
          ...
          <Link to="/house-of-fashion" className="mt-6 inline-block editorial-label hover:text-accent">← Boutique</Link>
        </div>
      </div>
    </PublicLayout>
  ),
    ...
    <PublicLayout>
      ...
      <section className="px-6 lg:px-16 py-16 border-t border-border-subtle">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-6">
          {related.map(p => (
            <Link key={p.id} to="/house-of-fashion/$productId" params={{ productId: p.id }} className="group">
              <div className="aspect-[3/4] overflow-hidden bg-surface">
