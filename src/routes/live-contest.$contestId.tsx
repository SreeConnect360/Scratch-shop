...
export const Route = createFileRoute("/live-contest/$contestId")({
  loader: ({ params }) => {
    ...
    <PublicLayout>
      <div className="min-h-[60vh] flex items-center justify-center text-center">
        <div>
          ...
          <Link to="/live-contest" className="mt-6 inline-block editorial-label hover:text-accent">← All battles</Link>
        </div>
      </div>
    </PublicLayout>
  ),
            ...
            {[battle.a, battle.b].map((c, i) => {
              ...
              return (
                <div key={c.id} className="group relative aspect-[3/4] overflow-hidden">
                  <Link to="/contestants/$slug" params={{ slug: c.slug }}>
