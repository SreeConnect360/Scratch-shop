...
export const Route = createFileRoute("/FashionBattle/photography/$photoId")({
    ...
    <PublicLayout>
      ...
      <section className="px-6 lg:px-16 py-10">
        <div className="max-w-5xl mx-auto">
          ...
          <Link to="/FashionBattle/best-photography" className="mt-6 inline-block editorial-label hover:text-accent">← All photography</Link>
        </div>
      </section>
    </PublicLayout>
  );
