...
export const Route = createFileRoute("/FashionBattle/contestants/$slug")({
  loader: ({ params }) => {
  ...
  notFoundComponent: () => (
    <PublicLayout>
      <div className="min-h-[60vh] flex items-center justify-center"><div className="text-center"><p className="editorial-label text-accent">404</p><h1 className="mt-4 font-serif text-5xl">Contestant Not Found</h1><Link to="/FashionBattle/angels" className="mt-8 inline-block editorial-label hover:text-accent">← Browse Angels</Link></div></div>
    </PublicLayout>
  ),
