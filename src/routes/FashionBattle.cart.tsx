...
export const Route = createFileRoute("/FashionBattle/cart")({
        ...
        <div className="lg:col-span-8">
          {state.cart.length === 0 ? (
            <div className="border border-dashed border-border-subtle p-20 text-center">
              ...
              <Link to="/FashionBattle/house-of-fashion" className="mt-8 inline-block bg-foreground text-background px-8 py-3.5 editorial-label hover:bg-accent hover:text-white transition-colors">Enter the Boutique</Link>
            </div>
          ) : (
