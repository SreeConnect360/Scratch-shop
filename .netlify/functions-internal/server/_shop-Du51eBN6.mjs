...
import { e as useNavigate, f as useLocation, L as Link, O as Outlet } from "./_libs/tanstack__react-router.mjs";
import { u as usePortal, a as useCartTotal, b as useTheme, Q as QuickAddContext, S as ShopNotificationContext, c as cn, p as prefersReducedMotion, B as BACKEND_URL } from "./_ssr/router-C0nupAs3.mjs";
import { t as toast } from "./_libs/sonner.mjs";
import "./_libs/react-oauth__google.mjs";
import "./_libs/maplibre-gl.mjs";
import { u as useMotionValue, a as useSpring, m as motion, A as AnimatePresence } from "./_libs/framer-motion.mjs";
import { S as Search, a6 as Heart, f as ShoppingBag, a7 as User, B as Bell, X, z as Sun, D as Moon, M as Menu, A as ArrowRight, a8 as Minus, P as Plus, n as Sparkles, a9 as MessageCircleCode, aa as Award, H as ShieldAlert, g as MapPin, W as Wallet, ab as Send } from "./_libs/lucide-react.mjs";
...
function SearchOverlay({ isOpen, onClose, products }) {
  ...
  const results = reactExports.useMemo(() => {
    ...
    return products.filter(
      (p) => (p.name || "").toLowerCase().includes(q) || (p.house || "").toLowerCase().includes(q)
    ).slice(0, 6);
  }, [query, products]);
  reactExports.useEffect(() => {
    if (isOpen) {
    ...
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSearchSubmit, className: "flex items-center gap-3 px-4 py-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 18, className: "shrink-0 text-gold", "aria-hidden": "true" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  ref: inputRef,
            ...
            query && /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { role: "list", className: "border-t border-white/10 p-2 space-y-1", children: [
              results.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "px-4 py-6 text-center text-sm text-ink-muted", children: [
                "Nothing found for “",
                query,
                "” — try different tags or collections."
              ] }),
                ...
                Link,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex-1 min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-sm text-ink truncate font-medium", children: p.name }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-xs text-gold font-bold", children: ensureRupees(p.price) })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ArrowRight,
                      {
...
function Particles({ count = 38 }) {
  ...
  reactExports.useEffect(() => {
    ...
    const tick = () => {
      ...
      const parX = (smooth.x - w / 2) / (w / 2 || 1);
      const parY = (smooth.y - h / 2) / (h / 2 || 1);
      ctx.clearRect(0, 0, w, h);
      for (const d of dots) {
        const driftX = d.hx + Math.sin(t + d.phase) * 26 + parX * 34 * d.depth;
        const driftY = d.hy + Math.cos(t * 0.8 + d.phase) * 20 + parY * 26 * d.depth;
...
function ShopLayout() {
  ...
  useSpring(ringX, ringSpringConfig);
  useSpring(ringY, ringSpringConfig);
  const [cursorType, setCursorType] = reactExports.useState("default");
  const [cursorText, setCursorText] = reactExports.useState("");
  ...
  searchQuery.trim() ? products.filter((p) => (p.name || "").toLowerCase().includes(searchQuery.toLowerCase()) || (p.house || "").toLowerCase().includes(searchQuery.toLowerCase())).slice(0, 5) : [];
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QuickAddContext.Provider, { value: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shop-portal-layout min-h-screen bg-background text-foreground flex flex-col font-sans transition-colors duration-300", children: [
      isHomepage && layout?.announcement?.enabled && !scrolled && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SearchOverlay, { isOpen: searchOpen, onClose: () => setSearchOpen(false), products }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("sticky top-3 z-50 px-3 sm:px-5 transition-all duration-500 ease-in-out", isProductPage && !showNavbar && "-translate-y-28 opacity-0 pointer-events-none"), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { ref: barRef, onMouseMove: onBarMove, className: cn("glass glass-reflect glass-edge mx-auto flex max-w-7xl items-center justify-between gap-2 rounded-2xl px-4 py-2.5 transition-shadow duration-500 sm:px-6 h-20 border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.15)]", scrolled && "glass-strong shadow-[var(--glass-shadow-hover)]"), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-10 z-10", children: [
            layout?.navigation?.visibleItems?.includes("Logo") !== false && /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "block transition-transform shrink-0 text-xl tracking-[0.3em] text-ink font-serif hover:opacity-90", children: [
              "R",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text", children: "EEVIBES" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden items-center gap-0.5 xl:flex", role: "list", children: layout?.navigation?.itemsOrder ? layout.navigation.itemsOrder.map((item) => {
              ...
              if (item === "Women") {
                return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/categories", className: "relative rounded-full px-3 py-1.5 text-[12.5px] tracking-[0.08em] font-semibold text-ink-muted hover:text-ink transition-colors duration-300", children: "Fashion" }) }, item);
              }
              if (item === "Collections") {
                return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/categories", search: {
                  view: "collections"
                }, className: "relative rounded-full px-3 py-1.5 text-[12.5px] tracking-[0.08em] font-semibold text-ink-muted hover:text-ink transition-colors duration-300", children: "Collections" }) }, item);
              }
              let linkSearch = {};
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/categories", search: linkSearch, className: "relative rounded-full px-3 py-1.5 text-[12.5px] tracking-[0.08em] font-semibold text-ink-muted hover:text-ink transition-colors duration-300", children: item === "New Arrivals" ? "New" : item }) }, item);
            }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "relative rounded-full px-3 py-1.5 text-[12.5px] tracking-[0.08em] font-semibold text-ink hover:text-ink transition-colors", children: "Shop" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/categories", className: "relative rounded-full px-3 py-1.5 text-[12.5px] tracking-[0.08em] font-semibold text-ink-muted hover:text-ink transition-colors", children: "Collections" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/FashionBattle/live-contest", className: "relative rounded-full px-3 py-1.5 text-[12.5px] tracking-[0.08em] font-semibold text-ink-muted hover:text-ink transition-colors", children: "Contests" }) })
            ] }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 z-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.button, { type: "button", onClick: () => setSearchOpen(true), whileHover: {
              scale: 1.12,
              rotate: 4
            }, whileTap: {
              scale: 0.9
            }, className: "relative flex h-10 w-10 items-center justify-center rounded-full text-ink-muted transition-colors duration-300 hover:text-ink cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { size: 18, strokeWidth: 1.8 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/account", search: {
              tab: "wishlist"
            }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.button, { type: "button", whileHover: {
              scale: 1.12,
              rotate: 4
            }, whileTap: {
              scale: 0.9
            }, className: "relative flex h-10 w-10 items-center justify-center rounded-full text-ink-muted transition-colors duration-300 hover:text-ink cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 18, strokeWidth: 1.8 }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/cart", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.button, { type: "button", whileHover: {
              scale: 1.12,
              rotate: 4
            }, whileTap: {
              scale: 0.9
            }, className: "relative flex h-10 w-10 items-center justify-center rounded-full text-ink-muted transition-colors duration-300 hover:text-ink cursor-pointer", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { size: 18, strokeWidth: 1.8 }),
              shopCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(motion.span, { initial: {
                scale: 0.4
              }, animate: {
                scale: 1
              }, transition: {
                ...
                stiffness: 500,
                damping: 18
              }, className: "absolute -right-0.5 -top-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-gold px-1 text-[9px] font-bold text-obsidian", children: shopCount }, shopCount)
            ] }) }),
            (!layout || layout.navigation.visibleItems.includes("Account")) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group py-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/account", search: {
                tab: "profile"
              }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.button, { type: "button", whileHover: {
                scale: 1.12,
                ...
                scale: 0.9
              }, className: "relative flex h-10 w-10 items-center justify-center rounded-full text-ink-muted transition-colors duration-300 hover:text-ink cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 18, strokeWidth: 1.8 }) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-1/2 -translate-x-1/2 top-full mt-1 w-52 bg-background/95 backdrop-blur-xl border border-accent/20 rounded-3xl p-4 shadow-[0_10px_40px_rgba(0,0,0,0.3)] dark:shadow-[0_10px_40px_rgba(0,0,0,0.5)] z-[110] opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-all duration-200 before:content-[''] before:absolute before:-top-3 before:left-0 before:right-0 before:h-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: [{
                tab: "profile",
                label: "Profile"
              }, {
                tab: "orders",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: notifRef, className: "relative group py-2", onMouseEnter: markNotificationsRead, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.button, { type: "button", whileHover: {
                scale: 1.12,
                rotate: 4
              }, whileTap: {
                scale: 0.9
              }, className: "relative flex h-10 w-10 items-center justify-center rounded-full text-ink-muted transition-colors duration-300 hover:text-ink cursor-pointer focus:outline-none animate-in", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { size: 18, strokeWidth: 1.8 }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute right-0 top-full mt-1 w-80 bg-background/95 backdrop-blur-xl border border-accent/20 rounded-3xl p-5 shadow-[0_10px_40px_rgba(0,0,0,0.3)] dark:shadow-[0_10px_40px_rgba(0,0,0,0.5)] z-[110] opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-all duration-200 before:content-[''] before:absolute before:-top-3 before:left-0 before:right-0 before:h-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(motion.button, { type: "button", "aria-label": `Switch to ${theme === "dark" ? "light" : "dark"} mode`, onClick: toggleTheme, whileHover: {
              scale: 1.1,
              rotate: 8
            }, whileTap: {
              scale: 0.88
            }, className: "relative ml-1 flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border border-[var(--glass-border)] bg-gold/5 text-gold transition-colors duration-300 hover:bg-gold/15 cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", initial: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.span, { initial: {
              y: 14,
              opacity: 0,
              rotate: -90,
              scale: 0.5
              ...
              duration: 0.35,
              ease: [0.22, 1, 0.36, 1]
            }, className: "flex", children: theme === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { size: 17, strokeWidth: 1.8 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { size: 17, strokeWidth: 1.8 }) }, theme) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "xl:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(motion.button, { type: "button", onClick: () => setMobileOpen((v) => !v), whileHover: {
              scale: 1.12,
              rotate: 4
            }, whileTap: {
              scale: 0.9
            }, className: "relative flex h-10 w-10 items-center justify-center rounded-full text-ink-muted transition-colors duration-300 hover:text-ink cursor-pointer", children: mobileOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 19, strokeWidth: 1.8 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { size: 19, strokeWidth: 1.8 }) }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
          opacity: 0,
          y: -12,
          scale: 0.98
        }, animate: {
          ...
          duration: 0.3,
          ease: [0.22, 1, 0.36, 1]
        }, className: "glass glass-strong absolute left-3 right-3 top-full mt-2 rounded-2xl p-3 xl:hidden border border-white/10 z-[200] shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { role: "list", className: "grid grid-cols-2 gap-1", children: layout?.navigation?.itemsOrder ? layout.navigation.itemsOrder.map((item) => {
          const isVisible = layout.navigation.visibleItems.includes(item);
          if (!isVisible || item === "Logo" || ["Search", "Wishlist", "Account", "Cart"].includes(item)) return null;
          if (item === "Men") return null;
          if (item === "Women") {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/categories", onClick: () => setMobileOpen(false), className: "w-full rounded-xl px-4 py-3 text-left text-sm tracking-wide transition-colors text-ink-muted hover:bg-gold/5 hover:text-ink block", children: "Fashion" }) }, item);
          }
          if (item === "Collections") {
            return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/categories", search: {
              view: "collections"
            }, onClick: () => setMobileOpen(false), className: "w-full rounded-xl px-4 py-3 text-left text-sm tracking-wide transition-colors text-ink-muted hover:bg-gold/5 hover:text-ink block", children: "Collections" }) }, item);
          }
          let linkSearch = {};
          if (item === "New Arrivals") linkSearch = {
            tag: "New"
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/categories", search: linkSearch, onClick: () => setMobileOpen(false), className: "w-full rounded-xl px-4 py-3 text-left text-sm tracking-wide transition-colors text-ink-muted hover:bg-gold/5 hover:text-ink block", children: item === "New Arrivals" ? "New" : item }) }, item);
        }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", onClick: () => setMobileOpen(false), className: "w-full rounded-xl px-4 py-3 text-left text-sm tracking-wide transition-colors text-ink hover:bg-gold/10 block", children: "Shop" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/categories", onClick: () => setMobileOpen(false), className: "w-full rounded-xl px-4 py-3 text-left text-sm tracking-wide transition-colors text-ink-muted hover:bg-gold/5 hover:text-ink block", children: "Collections" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/FashionBattle/live-contest", onClick: () => setMobileOpen(false), className: "w-full rounded-xl px-4 py-3 text-left text-sm tracking-wide transition-colors text-ink-muted hover:bg-gold/5 hover:text-ink block", children: "Contests" }) })
        ] }) }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
      !layout || layout.footer.enabled ? /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative z-10 pb-16 pt-8 max-w-7xl mx-auto w-full px-3 sm:px-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass glass-reflect glass-edge rounded-[2rem] px-7 py-10 sm:px-10 lg:px-14 border border-white/10 shadow-[var(--glass-shadow)]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 sm:grid-cols-2 md:grid-cols-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xl tracking-[0.3em] text-ink font-serif hover:opacity-90 transition-opacity", children: [
              "R",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-text", children: "EEVIBES" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-relaxed text-xs text-muted-foreground", children: layout?.footer?.aboutText || "ReeVibes is a high-fidelity luxury e-commerce experience designed for global styling curators." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground font-semibold uppercase tracking-wider text-xs", children: "Quick Links" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveFooterPopup("about"), className: "hover:text-accent transition-colors text-left font-semibold cursor-pointer bg-transparent border-none p-0 outline-none text-xs text-muted-foreground", children: "About Us" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveFooterPopup("returns"), className: "hover:text-accent transition-colors text-left font-semibold cursor-pointer bg-transparent border-none p-0 outline-none text-xs text-muted-foreground", children: "Returns & Exchanges" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveFooterPopup("privacy"), className: "hover:text-accent transition-colors text-left font-semibold cursor-pointer bg-transparent border-none p-0 outline-none text-xs text-muted-foreground", children: "Privacy Policy" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveFooterPopup("terms"), className: "hover:text-accent transition-colors text-left font-semibold cursor-pointer bg-transparent border-none p-0 outline-none text-xs text-muted-foreground", children: "Terms of Service" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 font-mono text-[11px] text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-foreground font-serif font-semibold uppercase tracking-wider not-mono text-xs", children: "Concierge Desk" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              "Phone: ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10 mt-8 pt-6 text-center text-[10px] text-muted-foreground", children: "© 2026 ReeVibes. Designed by Google DeepMind Team. All Rights Reserved." })
      ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative z-10 pb-8 pt-4 text-center text-[10px] text-muted-foreground", children: "© 2026 ReeVibes. Designed by Google DeepMind Team. All Rights Reserved." })
    ] }),
    ...
    (!layout || layout.chatbot?.enabled !== false) && /* @__PURE__ */ jsxRuntimeExports.jsx(AssistantLauncher, {})
  ] }) });
}
