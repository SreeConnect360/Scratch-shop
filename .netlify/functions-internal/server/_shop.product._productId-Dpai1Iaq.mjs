...
import { F as Route$f, u as usePortal, k as useShopNotification, c as cn } from "./_ssr/router-C0nupAs3.mjs";
import { t as toast } from "./_libs/sonner.mjs";
import { F as FadeUp } from "./_ssr/Reveal-DABDixyV.mjs";
import "./_libs/react-oauth__google.mjs";
import "./_libs/maplibre-gl.mjs";
import { Q as ArrowLeft, b as ChevronLeft, A as ArrowRight, s as Star, f as ShoppingBag, a6 as Heart, p as Truck, an as RotateCcw, e as Shield, a8 as Minus, P as Plus, X } from "./_libs/lucide-react.mjs";
...
function parseProductInfo(text) {
  ...
  for (let line of lines) {
    ...
    const isPlainHeading = trimmed.length < 45 && !trimmed.includes("	") && !trimmed.includes(":") && !trimmed.startsWith("-") && !trimmed.startsWith("•") && isNaN(Number(trimmed));
    let headingName = "";
...
function renderLine(line) {
  ...
  if (trimmed.includes("	")) {
    ...
    const knownPrefixes = ["Material composition", "Country of Origin", "Fit type", "Sleeve type", "Collar style", "Fitting type", "Style Name", "Neck Style", "Sleeve Type", "Shirt Form Type", "Sport Type", "Apparel Closure Type", "Cuff Style", "Apparel Occasion and Lifestyle", "Occasion description", "Brand Name", "Model Name", "Style Number", "Unit Count", "Manufacturer Part Number", "Age Range Description", "Item Type Name", "Best Sellers Rank"];
  ...
  if (key && value) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 py-2 border-b border-white/5 last:border-0 text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-muted-foreground col-span-1 pr-2", children: key }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/90 col-span-2", children: value })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-1 text-xs text-foreground/80 leading-relaxed list-item list-inside ml-1", children: trimmed });
}
function ProductDetail() {
  ...
  const infoEndRef = reactExports.useRef(null);
  const [showRelated, setShowRelated] = reactExports.useState(false);
  ...
  const [openInfoSections, setOpenInfoSections] = reactExports.useState({
    0: true
  });
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-16 py-12 space-y-16", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-12 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7 lg:sticky lg:top-24 self-start flex gap-4 w-full max-h-[70vh] lg:max-h-[calc(100vh-140px)]", children: [
        mediaGallery.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3 overflow-y-auto pr-1 shrink-0 scrollbar-none justify-start max-h-[70vh] lg:max-h-full", children: mediaGallery.map((m, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveMediaIdx(idx), className: `w-16 h-20 border overflow-hidden shrink-0 rounded-xl transition-all duration-300 ${activeMediaIdx === idx ? "border-accent scale-95 shadow-[0_0_15px_rgba(212,175,55,0.4)]" : "border-white/10 hover:border-white/30"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: m, className: "w-full h-full object-cover" }) }, idx)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-zinc-950 aspect-[3/4] lg:aspect-auto lg:flex-1 lg:min-h-0 overflow-hidden rounded-3xl border border-border-subtle cursor-zoom-in flex items-center justify-center flex-1", onMouseMove: handleMouseMove, onMouseLeave: handleMouseLeave, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: mediaGallery[activeMediaIdx], className: "max-w-full max-h-full object-contain select-none pointer-events-none" }),
          ...
          mediaGallery.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveMediaIdx((prev) => prev === 0 ? mediaGallery.length - 1 : prev - 1), className: "absolute left-4 top-1/2 -translate-y-1/2 bg-black/60 text-white p-2.5 rounded-full hover:bg-black transition-colors z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "w-4 h-4" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveMediaIdx((prev) => prev === mediaGallery.length - 1 ? 0 : prev + 1), className: "absolute right-4 top-1/2 -translate-y-1/2 bg-black/60 text-white p-2.5 rounded-full hover:bg-black transition-colors z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4" }) })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(FadeUp, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5 mt-4", children: hasDiscount ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl md:text-4xl font-serif text-accent font-semibold", children: displayFinalPrice }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs md:text-sm text-muted-foreground", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "M.R.P." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "line-through", children: displayOrigPrice }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-red-500 ml-1", children: [
                "(",
                displayPct,
                "% OFF)"
              ] })
        ...
        product.productInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-6 border-t border-border-subtle", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-sm uppercase tracking-wider text-foreground font-semibold", children: "Product Information" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: parseProductInfo(product.productInfo).map((section, idx) => {
            const isOpen = !!openInfoSections[idx];
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-white/10 rounded-2xl overflow-hidden bg-white/5 backdrop-blur-md", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setOpenInfoSections((prev) => ({
                ...prev,
                [idx]: !prev[idx]
              })), className: "w-full flex items-center justify-between p-4 text-xs font-semibold text-foreground hover:bg-white/5 transition-all text-left uppercase tracking-wider", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: section.heading }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "w-3.5 h-3.5 text-accent" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-3.5 h-3.5 text-accent" }) })
              ] }),
              isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-4 pt-1 border-t border-white/5 space-y-2 bg-black/10", children: section.lines.map((line, lIdx) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: renderLine(line) }, lIdx)) })
            ] }, idx);
          }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: infoEndRef, className: "h-1 w-full" })
      ] })
    ] }),
    ...
    relatedProducts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("space-y-8 border-t border-border-subtle pt-12 transition-all duration-1000 ease-out transform", showRelated ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12 pointer-events-none"), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-6", children: relatedProducts.map((p) => {
        const wishlist = state.shopWishlist[state.user?.id || ""] || [];
        return /* @__PURE__ */ jsxRuntimeExports.jsx(RelatedProductCard, { p, toggleShopWishlist, addToShopCart, wishlist }, p.id);
      }) })
    ] }),
...
function RelatedProductCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, onMouseMove: handleMove, onMouseLeave: handleLeave, className: "group glass glass-reflect glass-edge relative overflow-hidden rounded-3xl transition-[transform,box-shadow] duration-500 ease-out will-change-transform hover:shadow-[var(--glass-shadow-hover)] flex flex-col justify-between h-full cursor-pointer", style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/5] overflow-hidden bg-charcoal/5", children: [
      ...
      gallery.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        }, className: "absolute right-3 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-accent text-white p-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity z-20 duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-3.5 h-3.5" }) })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-[2] flex flex-col justify-between p-5 bg-black/25 flex-1 space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 items-baseline flex-wrap mt-2", children: [
        ...
        hasDiscount && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs line-through text-muted-foreground", children: displayOrigPrice }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold text-red-500", children: [
            "-",
            displayPct,
            "% off"
          ] })
