...
const TABS = ["Applied", "Approved", "Hold", "Thank You", "Block"];
...
function RoleApplicationsPage() {
  ...
  const [contestId, setContestId] = reactExports.useState(state.contests.find((c) => c.country === country)?.id ?? "");
  const [tab, setTab] = reactExports.useState("Applied");
  const [pendingStatus, setPendingStatus] = reactExports.useState({});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "editorial-eyebrow text-accent", children: "Role · Applications" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-2 font-serif text-3xl", children: "Application Review" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: country, onChange: (e) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: contestId, onChange: (e) => setContestId(e.target.value), className: "bg-transparent border border-border-subtle px-3 py-2 text-sm rounded bg-background", children: state.contests.filter((c) => c.country === country).map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: c.id, className: "bg-background", children: [
        c.year,
        " · ",
        c.stage
      ] }, c.id)) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1 editorial-label", children: TABS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
      ...
      t,
      " (",
      apps.filter((a) => (state.applicationsWorkflow[a.contestantId] ?? "Applied") === t).length,
      ")"
    ] }, t)) }),
    filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border-subtle p-4 space-y-3 bg-surface rounded flex flex-col justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 mt-4 pt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: currentStatus, onChange: (e) => setPendingStatus((prev) => ({
            ...prev,
...
export {
  RoleApplicationsPage as component
};
