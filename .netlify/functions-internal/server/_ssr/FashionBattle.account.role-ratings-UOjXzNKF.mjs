...
import { S as Slider } from "./slider-GQxdWhiH.mjs";
...
function RoleRatingsPage() {
  ...
  const [pendingRatings, setPendingRatings] = reactExports.useState({});
  ...
  const list = tab === "Approved" ? apps.filter((a) => myScores[a.contestantId] === void 0) : apps.filter((a) => myScores[a.contestantId] !== void 0);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "editorial-eyebrow text-accent", children: "Role · Ratings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-2 font-serif text-3xl", children: "Rate Approved Contestants" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 editorial-label", children: ["Approved", "Rated"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
      setTab(t);
      setPendingRatings({});
    }, className: `px-3 py-1 border transition-colors ${tab === t ? "border-accent text-accent bg-accent/5" : "border-border-subtle text-muted-foreground"}`, children: t }, t)) }),
    list.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
      "No contestants to ",
      tab === "Approved" ? "rate" : "show",
      "."
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: list.map((a) => {
      const savedScore = myScores[a.contestantId];
      const currentScore = pendingRatings[a.contestantId] ?? savedScore ?? 0;
      const isChanged = pendingRatings[a.contestantId] !== void 0 && pendingRatings[a.contestantId] !== savedScore;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border-subtle p-4 flex gap-4 items-center bg-surface rounded", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-20 h-24 overflow-hidden border border-border-subtle rounded group shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: a.photos.portrait, className: "w-full h-full object-cover cursor-pointer", onClick: () => setViewingContestant(a) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity cursor-pointer text-[8px] uppercase tracking-wider text-white text-center p-1", onClick: () => setViewingContestant(a), children: "View Info" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-lg leading-tight", children: a.fullName }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "editorial-label text-muted-foreground text-[10px]", children: a.contestantId })
            ] }),
            ...
            }, className: `px-4 py-2 text-[10px] uppercase tracking-wider font-semibold border transition-all duration-300 rounded-sm ${isChanged ? "text-white cursor-pointer font-bold" : "bg-transparent border-border-subtle text-muted-foreground cursor-not-allowed opacity-50"}`, style: isChanged ? {
              backgroundColor: "#db2777",
              borderColor: "#db2777"
            } : {}, children: "Save Judges" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { value: [currentScore], max: 10, step: 1, onValueChange: (v) => setPendingRatings((prev) => ({
              ...prev,
              [a.contestantId]: v[0]
            })), className: "flex-1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-2xl w-10 text-right", children: currentScore })
          ] })
        ] })
      ] }, a.contestantId);
    }) }),
