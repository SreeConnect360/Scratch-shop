...
/**
 * Floating Liquid Glass navbar: sticky, pointer-lit, with a gliding active
  ...
  return (
    <div className="sticky top-3 z-50 px-3 sm:px-5">
      <motion.nav
        ...
        className={cn(
          "glass glass-reflect glass-edge mx-auto flex max-w-7xl items-center justify-between gap-2 rounded-2xl px-4 py-2.5 transition-shadow duration-500 sm:px-6",
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="glass glass-strong absolute left-3 right-3 top-full mt-2 rounded-2xl p-3 xl:hidden"
          >
