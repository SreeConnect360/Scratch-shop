...
import { E as Earth, S as Search, C as Crown, U as UsersRound, L as Lock, a as CircleCheckBig, b as ChevronLeft, M as Menu, X, B as Bell, c as ChevronDown, d as ChevronRight, F as Funnel, P as Plus, e as Shield, f as ShoppingBag, T as Trash2, g as MapPin, h as Save, i as Pen, A as ArrowRight, j as CreditCard, k as CircleCheck, W as Wallet, l as Tag, m as LayoutGrid, n as Sparkles, o as Layers, p as Truck, R as RefreshCw, q as Users, r as Ticket, s as Star, t as Store, u as Radio, v as Camera, w as UserCheck, x as Flag, y as ChartColumn, z as Sun, D as Moon, G as ShieldAlert, H as EyeOff, I as Eye, J as ArrowUpRight, V as Video, K as Play, N as GripVertical, O as Upload, Q as Link$1, Y as Settings, Z as History, _ as SquareCheckBig, $ as Square, a0 as Undo } from "../_libs/lucide-react.mjs";
...
const appCss = "/assets/styles-Bei5MLRh.css";
...
function PortalProvider({ children }) {
  ...
  const fetchBackendVendorsAndProducts = reactExports.useCallback(async () => {
    try {
      const vendorsRes = await fetch("http://localhost:8081/api/vendors");
      ...
      const res = await fetch("http://localhost:8081/api/vendors/products");
      if (res.ok) {
        ...
        setState((s) => {
          ...
          const filteredDefault = PRODUCTS.filter((p) => !existingIds.has(String(p.id)));
          return {
            ...s,
  ...
  reactExports.useEffect(() => {
    ...
    const checkedProducts = (loadedState.products || []).map((p) => {
      if (p.images && p.images.length > 0) {
        ...
        if (first.startsWith("http://localhost:8081")) {
          p.img = first;
        }
      }
      return p;
  ...
  const api = reactExports.useMemo(() => ({
    ...
    updateProduct: (id, patch) => {
      ...
      if (id.startsWith("vp-") || id.startsWith("vnd-") || id.includes("-catalog")) {
        ...
        fetch(`http://localhost:8081/api/vendors/products/${id}`, {
          method: "PUT",
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PortalProvider, { children: [
...
const $$splitComponentImporter$I = () => import("../_shop-rUliWvuQ.mjs");
...
const Route$P = createFileRoute("/_shop")({
  component: lazyRouteComponent($$splitComponentImporter$I, "component")
});
const $$splitComponentImporter$H = () => import("./admin.index-BQsBcqtE.mjs");
...
const $$splitComponentImporter$G = () => import("../_shop.index-DCV5ZpB2.mjs");
const Route$N = createFileRoute("/_shop/")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$F = () => import("./FashionBattle.index-BoWWwfw6.mjs");
const Route$M = createFileRoute("/FashionBattle/")({
  head: () => ({
    meta: [{
...
const Route$L = createFileRoute("/api/sponsors")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        try {
...
const Route$K = createFileRoute("/api/flags")({
  server: {
    handlers: {
      GET: async () => {
        try {
...
const Route$J = createFileRoute("/api/countries-logos")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        try {
...
const Route$I = createFileRoute("/api/angels")({
  server: {
    handlers: {
      GET: async () => {
        try {
...
const $$splitComponentImporter$E = () => import("./admin.vote-control-DF4ueOac.mjs");
const Route$H = createFileRoute("/admin/vote-control")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$D = () => import("./admin.users-BGTyXQuq.mjs");
...
const BASE_URL = "http://localhost:8081/api/vendors";
...
function ShopAdminPortal({ tab }) {
  ...
  reactExports.useEffect(() => {
    if (state && state.homepageLayoutDraft && !draftLayout) {
      setDraftLayout(state.homepageLayoutDraft);
    }
  }, [state, draftLayout]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    ...
    selectedOrderDetails && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "liquid-glass max-w-xl w-full p-6 md:p-8 space-y-6 shadow-2xl animate-in zoom-in-95 duration-200", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-xs leading-relaxed", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 border-b border-white/5 pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-semibold", children: "Order Date:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "col-span-2", children: selectedOrderDetails.date })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 border-b border-white/5 pb-2", children: [
    ...
    tab === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in duration-200", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
        ...
        ["Orders Today", ordersList.filter((o) => o.date === (/* @__PURE__ */ new Date()).toISOString().slice(0, 10)).length.toString(), "Real-time updates"],
        ["Revenue Today", "₹" + ordersList.filter((o) => o.date === (/* @__PURE__ */ new Date()).toISOString().slice(0, 10)).reduce((sum, o) => sum + o.total, 0).toLocaleString(), "Paid orders"]
      ].map(([k, v, d]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(AdminCard, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "editorial-label text-muted-foreground", children: k }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-3xl mt-3", children: v }),
          ...
          "form",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-56 overflow-y-auto border border-border-subtle bg-surface p-2 rounded-xl space-y-1.5 scrollbar-thin grid grid-cols-1 md:grid-cols-2 gap-2", children: productsList.filter(
                  (p) => p.name.toLowerCase().includes(bucketProductSearch.toLowerCase()) || p.house.toLowerCase().includes(bucketProductSearch.toLowerCase())
                ).map((p) => {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "button",
                          {
                            ...
                            className: `p-1 hover:text-amber-400 transition-colors ml-2 ${isStar ? "text-amber-400" : "text-muted-foreground/30"}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => {
                ...
                triggerModal("success", "Draft Saved", "Your current layout settings have been saved to the working draft.", () => {
                });
              },
              className: "editorial-label text-xs bg-surface-3 hover:bg-surface-4 text-foreground border border-border-subtle px-4 py-2 rounded-full transition-all",
              children: "Save Draft"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: "/shop?preview=true",
              target: "_blank",
              rel: "noreferrer",
              className: "editorial-label text-xs bg-surface-3 hover:bg-surface-4 text-foreground border border-border-subtle px-4 py-2 rounded-full transition-all inline-flex items-center gap-1",
              children: [
                "External Preview ",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    onClick: () => {
                      ...
                      const name = prompt("Enter Banner Section Name:", "New Banner Section");
                      if (!name) return;
                      setDraftLayout({
                        ...draftLayout,
                    ...
                    className: "bg-accent/20 text-accent hover:bg-accent hover:text-white px-2 py-1 rounded text-[9px] uppercase font-bold tracking-wider",
                    children: "+ Banner"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    onClick: () => {
                      const bList = state.buckets || [];
                      if (bList.length === 0) {
                        alert("Please create a Bucket in the Buckets Curation tab first!");
                        return;
                      }
                      const bktOptions = bList.map((b) => `${b.id}: ${b.name}`).join("\n");
                      const choice = prompt(`Select Bucket ID to add:

${bktOptions}`);
                      if (!choice) return;
                      const matched = bList.find((b) => b.id === choice.trim() || b.name.toLowerCase() === choice.trim().toLowerCase());
                      if (!matched) {
                        alert("Invalid Bucket ID or Name!");
                        return;
                      }
                      const id = `bucket-${matched.id}`;
                      if (draftLayout.sectionOrder.includes(id)) {
                        alert("This bucket is already on the homepage layout!");
                        return;
                      }
                      setDraftLayout({
                        ...draftLayout,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 max-h-[380px] overflow-y-auto pr-2 divide-y divide-white/5 scrollbar-thin", children: draftLayout.sectionOrder.map((secId, idx) => {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold", children: secId.startsWith("banner-") ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-amber-400", children: [
                            "Banner: ",
                            sec.name || "Unnamed"
                          ] }) : secId.startsWith("bucket-") ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-emerald-400", children: [
                            "Bucket: ",
                            state.buckets?.find((b) => b.id === sec.id)?.name || sec.id
                          ] }) : secId.replace(/([A-Z])/g, " $1") }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          disabled: idx === draftLayout.sectionOrder.length - 1,
                          onClick: () => {
                            const nextOrder = [...draftLayout.sectionOrder];
                            const temp = nextOrder[idx];
                            nextOrder[idx] = nextOrder[idx + 1];
                      ...
                      (secId.startsWith("banner-") || secId.startsWith("bucket-")) && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          onClick: () => {
                            if (confirm("Remove this custom section from layout?")) {
          ...
          activeSectionId && draftLayout[activeSectionId] && /* @__PURE__ */ jsxRuntimeExports.jsxs(AdminCard, { className: "space-y-4 animate-in slide-in-from-bottom-2 duration-200", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-xs", children: [
              activeSectionId === "announcement" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                draftLayout.announcement.countdownActive && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 animate-in fade-in duration-200", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    {
                      type: "text",
                      placeholder: "2026-07-31T23:59:59",
                      className: "w-full bg-surface border border-border-subtle p-2 text-sm outline-none text-foreground font-mono",
                      value: draftLayout.announcement.countdownEndsAt,
                      onChange: (e) => {
                        const val = e.target.value;
              ...
              activeSectionId === "hero" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      onClick: () => {
                        ...
                        setDraftLayout({
                          ...draftLayout,
                          hero: { ...draftLayout.hero, banners: [...draftLayout.hero.banners, newBanner] }
                        });
                      },
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 max-h-[300px] overflow-y-auto pr-1 divide-y divide-white/5 scrollbar-thin", children: draftLayout.hero.banners.map((b, bIdx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-3 first:pt-0 space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        onClick: () => {
                          setDraftLayout({
                            ...draftLayout,
                            hero: { ...draftLayout.hero, banners: draftLayout.hero.banners.filter((x) => x.id !== b.id) }
                          });
                        },
              ...
              activeSectionId.startsWith("banner-") && draftLayout[activeSectionId] && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-muted-foreground font-semibold", children: "Banner Section Name" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      type: "text",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    {
                      type: "text",
                      className: "w-full bg-surface border border-border-subtle p-2 outline-none text-foreground font-mono text-xs",
                      value: draftLayout[activeSectionId].desktopImage || "",
                      onChange: (e) => setDraftLayout({
                        ...draftLayout,
                        [activeSectionId]: { ...draftLayout[activeSectionId], desktopImage: e.target.value }
                      })
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-muted-foreground font-semibold", children: "Mobile Image URL" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      type: "text",
                      className: "w-full bg-surface border border-border-subtle p-2 outline-none text-foreground font-mono text-xs",
                      value: draftLayout[activeSectionId].mobileImage || "",
                      onChange: (e) => setDraftLayout({
                        ...draftLayout,
                        [activeSectionId]: { ...draftLayout[activeSectionId], mobileImage: e.target.value }
                      })
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      type: "text",
                      className: "w-full bg-surface border border-border-subtle p-2 outline-none text-foreground font-mono text-xs",
                      value: draftLayout[activeSectionId].redirectUrl || "",
                      onChange: (e) => setDraftLayout({
                        ...draftLayout,
                        [activeSectionId]: { ...draftLayout[activeSectionId], redirectUrl: e.target.value }
                      })
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 bg-white/5 border border-white/10 rounded-xl space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-[10px] text-accent uppercase tracking-wider", children: "Advanced Crop & Zoom Panning" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-[10px]", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground font-semibold", children: [
                        "Scale (Zoom): ",
                        (draftLayout[activeSectionId].scale || 1).toFixed(1),
                        "x"
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          onClick: () => setDraftLayout({
                            ...draftLayout,
                            [activeSectionId]: { ...draftLayout[activeSectionId], scale: 1, xOffset: 0, yOffset: 0 }
                          }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        ...
                        value: draftLayout[activeSectionId].scale || 1,
                        onChange: (e) => setDraftLayout({
                          ...draftLayout,
                          [activeSectionId]: { ...draftLayout[activeSectionId], scale: parseFloat(e.target.value) }
                        })
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-[10px] text-muted-foreground font-semibold", children: [
                        "Offset X: ",
                        draftLayout[activeSectionId].xOffset || 0,
                        "%"
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          ...
                          max: "100",
                          className: "w-full accent-accent",
                          value: draftLayout[activeSectionId].xOffset || 0,
                          onChange: (e) => setDraftLayout({
                            ...draftLayout,
                            [activeSectionId]: { ...draftLayout[activeSectionId], xOffset: parseInt(e.target.value) }
                          })
                        }
                      )
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-[10px] text-muted-foreground font-semibold", children: [
                        "Offset Y: ",
                        draftLayout[activeSectionId].yOffset || 0,
                        "%"
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "input",
                        {
                          ...
                          max: "100",
                          className: "w-full accent-accent",
                          value: draftLayout[activeSectionId].yOffset || 0,
                          onChange: (e) => setDraftLayout({
                            ...draftLayout,
                            [activeSectionId]: { ...draftLayout[activeSectionId], yOffset: parseInt(e.target.value) }
                          })
                        }
                      )
                    ] })
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground font-semibold", children: "Cropped Frame Preview:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative aspect-[21/9] w-full bg-zinc-950 border border-white/10 rounded-lg overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: "w-full h-full bg-center bg-cover transition-all",
                        style: {
                          backgroundImage: `url(${draftLayout[activeSectionId].desktopImage})`,
                          transform: `scale(${draftLayout[activeSectionId].scale || 1}) translate(${draftLayout[activeSectionId].xOffset || 0}%, ${draftLayout[activeSectionId].yOffset || 0}%)`,
              ...
              !["announcement", "navigation", "hero", "categories", "flashSale", "trending", "newArrivals", "campaign", "collections", "liveFeed", "bestSellers", "limitedStock", "influencerPicks", "reviews", "lookbook", "recommended", "brandStory", "newsletter", "footer"].includes(activeSectionId) && !activeSectionId.startsWith("banner-") && !activeSectionId.startsWith("bucket-") && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-6 text-muted-foreground italic", children: "No specialized controls required. Use the switch above to toggle section visibility." })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-7 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-serif font-semibold", children: "Real-time Layout Visualizer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex bg-surface-2 border border-border-subtle p-0.5 rounded-full", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: () => setPreviewDevice("desktop"),
                  className: `px-3 py-1 text-[10px] uppercase font-bold tracking-widest rounded-full transition-all ${previewDevice === "desktop" ? "bg-foreground text-background" : "text-muted-foreground hover:text-foreground"}`,
                  children: "Desktop"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `px-3 py-1 text-[10px] uppercase font-bold tracking-widest rounded-full transition-all ${previewDevice === "mobile" ? "bg-foreground text-background" : "text-muted-foreground hover:text-foreground"}`,
                  children: "Mobile"
                }
              )
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `border border-white/10 rounded-3xl bg-zinc-950 flex flex-col h-[750px] shadow-2xl transition-all overflow-hidden ${previewDevice === "mobile" ? "max-w-[375px] mx-auto border-4 border-zinc-800" : "w-full"}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface border-b border-white/5 px-4 py-2.5 flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5 shrink-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2.5 h-2.5 rounded-full bg-rose-500/80" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2.5 h-2.5 rounded-full bg-amber-500/80" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2.5 h-2.5 rounded-full bg-emerald-500/80" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-zinc-900 border border-white/5 text-[9px] text-muted-foreground px-6 py-1 rounded-md font-mono select-none truncate max-w-[200px] md:max-w-md", children: "shop.reevibes.com/?preview=true" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto space-y-8 scrollbar-thin bg-[#09090b] text-white pb-16", children: draftLayout.sectionOrder.map((secId) => {
                  const sec = draftLayout[secId];
                  ...
                  switch (secId) {
                    case "announcement":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          style: { backgroundColor: draftLayout.announcement.backgroundColor },
                          className: "w-full text-center py-2 text-[10px] font-semibold tracking-widest uppercase text-white animate-in slide-in-from-top-2 duration-300",
                          children: [
                            draftLayout.announcement.text || "Announcement Message",
                            draftLayout.announcement.countdownActive && /* @__PURE__ */ jsxRuntimeExports.jsx(
                              LiveCountdown,
                              {
                                endsAt: draftLayout.announcement.countdownEndsAt,
                                onComplete: () => {
                                  const updated = {
                                    ...draftLayout,
                                    announcement: {
                    ...
                    case "navigation":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 bg-zinc-950/80 backdrop-blur-md border-b border-white/5 flex items-center justify-between sticky top-0 z-10", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif font-bold text-sm tracking-[0.15em]", children: "REEVIBES" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 text-[9px] uppercase tracking-wider text-muted-foreground", children: draftLayout.navigation.visibleItems.filter((x) => x !== "Logo").slice(0, 4).map((x) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hover:text-white cursor-pointer", children: x }, x)) })
                      ] }, secId);
                    case "hero":
                      const firstBanner = draftLayout.hero.banners[0];
                      return firstBanner ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/9] w-full bg-zinc-900 overflow-hidden", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "img",
                          {
                            src: previewDevice === "mobile" ? firstBanner.mobileImage : firstBanner.desktopImage,
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 p-4 space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] uppercase tracking-widest text-accent font-bold", children: firstBanner.subtitle }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-lg text-white font-bold leading-tight", children: firstBanner.title }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-white text-black text-[9px] uppercase tracking-widest px-3 py-1 font-bold rounded-sm mt-1", children: firstBanner.buttonText })
                        ] })
                      ] }, secId) : null;
                    case "categories":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 space-y-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-widest text-accent font-bold", children: "Categories Curation" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: draftLayout.categories.items.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/3] rounded-lg overflow-hidden bg-zinc-900 border border-white/5", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: cat.image, className: "w-full h-full object-cover opacity-60", alt: "" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-2 left-2 text-[10px] font-bold tracking-wider", children: cat.name })
                        ] }, cat.id)) })
                      ] }, secId);
                    case "flashSale":
                      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-red-950/20 via-zinc-900/40 to-black border border-red-500/20 p-3 rounded-2xl flex items-center justify-between", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] text-red-400 uppercase tracking-widest font-bold", children: "Flash Sale" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-serif text-xs mt-0.5", children: [
                            "Flat ",
                            draftLayout.flashSale.discount,
                            "% OFF Curation"
                          ] })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[8px] text-muted-foreground uppercase tracking-widest", children: "Ends In" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] font-bold text-red-400", children: "12h : 22m : 30s" })
                        ] })
                      ] }) }, secId);
                    case "trending":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 space-y-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-white/5 pb-1 flex justify-between items-end", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-widest text-accent font-bold", children: "Trending Right Now" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] text-muted-foreground", children: "Auto Ranked" })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: productsList.slice(0, 2).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.image, className: "aspect-[3/4] object-cover rounded-lg w-full", alt: "" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-semibold truncate", children: p.name }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] text-accent font-bold", children: p.price })
                        ] }, p.id)) })
                      ] }, secId);
                    case "newArrivals":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 space-y-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-white/5 pb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-widest text-accent font-bold", children: "New Arrivals" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: productsList.slice(2, 4).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.image, className: "aspect-[3/4] object-cover rounded-lg w-full", alt: "" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-semibold truncate", children: p.name }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] text-accent font-bold", children: p.price })
                        ] }, p.id)) })
                    ...
                    case "campaign":
                      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[2/1] rounded-2xl overflow-hidden bg-zinc-900 border border-white/5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: draftLayout.campaign.image, className: "absolute inset-0 w-full h-full object-cover opacity-60", alt: "" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-black/40 flex flex-col justify-end p-4", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-serif text-sm font-bold text-white", children: draftLayout.campaign.heading }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "text-[8px] uppercase tracking-widest text-white mt-1 hover:underline text-left font-bold", children: draftLayout.campaign.ctaText })
                        ] })
                      ] }) }, secId);
                    case "collections":
                      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[2/1] rounded-2xl overflow-hidden bg-zinc-900 border border-white/5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: draftLayout.collections.coverImage, className: "absolute inset-0 w-full h-full object-cover opacity-65", alt: "" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-md italic tracking-widest text-white border border-white/20 px-6 py-2 backdrop-blur-sm bg-black/25 uppercase font-bold", children: draftLayout.collections.collectionId }) })
                      ] }) }, secId);
                    case "liveFeed":
                      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface border border-white/10 rounded-full py-1.5 px-4 flex items-center gap-2 justify-center max-w-sm mx-auto shadow-md", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] tracking-wide text-muted-foreground", children: "Rahul purchased Oversized Hoodie 5 minutes ago" })
                      ] }) }, secId);
                    case "bestSellers":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 space-y-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-white/5 pb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-widest text-accent font-bold", children: "Best Sellers" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: productsList.slice(4, 6).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.image, className: "aspect-[3/4] object-cover rounded-lg w-full", alt: "" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-semibold truncate", children: p.name }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] text-accent font-bold", children: p.price })
                        ] }, p.id)) })
                    ...
                    case "limitedStock":
                      return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-amber-500/10 border border-amber-500/20 p-3 rounded-2xl text-center", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] text-amber-400 uppercase tracking-widest font-bold", children: "Limited Curation Warning" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-muted-foreground mt-1", children: [
                          "Hurry! Only ",
                          draftLayout.limitedStock.threshold,
                          " items remaining on featured fits."
                        ] })
                      ] }) }, secId);
                    case "influencerPicks":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 space-y-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-white/5 pb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-widest text-accent font-bold", children: "Influencer Stylist Picks" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: productsList.slice(0, 2).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.image, className: "aspect-[3/4] object-cover rounded-lg w-full", alt: "" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-semibold truncate", children: p.name }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] text-accent font-bold", children: p.price })
                    ...
                    case "reviews":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-4 bg-white/5 border-y border-white/5 text-center", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-accent uppercase tracking-widest font-bold", children: "Verified Reviews" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs italic mt-2", children: '"Absolutely stunning dress! Fits perfectly and the silk material feels incredibly premium."' }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground block mt-1", children: "— Aditi Rao" })
                      ] }, secId);
                    case "lookbook":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 space-y-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-widest text-accent font-bold", children: "Fashion Lookbook" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[3/4] rounded-2xl overflow-hidden bg-zinc-900 border border-white/5", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: draftLayout.lookbook.image, className: "w-full h-full object-cover", alt: "" }),
                          draftLayout.lookbook.taggedProducts.map((tag, tIdx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              className: "absolute w-3.5 h-3.5 bg-accent border border-white rounded-full flex items-center justify-center text-[7px] text-white font-bold cursor-pointer",
                              style: { left: `${tag.x}%`, top: `${tag.y}%`, transform: "translate(-50%, -50%)" },
                              children: tIdx + 1
                            },
                            tIdx
                    ...
                    case "recentlyViewed":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 space-y-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-widest text-muted-foreground font-semibold", children: "Recently Viewed" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 overflow-x-auto pb-1 scrollbar-none", children: productsList.slice(1, 3).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-24 shrink-0 space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.image, className: "aspect-[3/4] object-cover rounded-md", alt: "" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-semibold truncate", children: p.name })
                        ] }, p.id)) })
                      ] }, secId);
                    case "recommended":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 space-y-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-widest text-accent font-bold", children: "Recommended For You" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: productsList.slice(3, 5).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.image, className: "aspect-[3/4] object-cover rounded-lg w-full", alt: "" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-semibold truncate", children: p.name })
                        ] }, p.id)) })
                      ] }, secId);
                    case "brandStory":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 space-y-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] uppercase tracking-widest text-accent font-bold", children: "Maison ReeVibes" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground leading-relaxed", children: draftLayout.brandStory.text }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: draftLayout.brandStory.image1, className: "aspect-[4/5] object-cover rounded-lg", alt: "" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: draftLayout.brandStory.image2, className: "aspect-[4/5] object-cover rounded-lg", alt: "" })
                        ] })
                      ] }, secId);
                    case "newsletter":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-6 bg-accent/10 border border-accent/20 rounded-2xl text-center space-y-3", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "font-serif text-sm font-bold", children: [
                            "Unlock ₹",
                            draftLayout.newsletter.rewardAmount,
                            " Off"
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-muted-foreground mt-0.5", children: "Subscribe to curations & receive first purchase reward." })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "input",
                          {
                            ...
                            disabled: true,
                            className: "w-full bg-zinc-950 border border-white/10 rounded-full py-1.5 px-4 text-[10px] text-center"
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-white text-black text-[9px] font-bold uppercase tracking-widest py-1.5 px-6 rounded-full w-full", children: "Claim Reward" })
                      ] }, secId);
                    case "footer":
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-8 bg-zinc-950 border-t border-white/5 space-y-4 text-[9px] text-muted-foreground", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif font-bold text-white text-[11px] tracking-wider", children: "REEVIBES" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 leading-relaxed", children: draftLayout.footer.aboutText })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-semibold uppercase tracking-wider", children: "Concierge" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            "Phone: ",
                            draftLayout.footer.phone
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            "Email: ",
                            draftLayout.footer.email
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            "Address: ",
                            draftLayout.footer.address
                          ] })
                        ] })
                      ] }, secId);
                    default:
                      if (secId.startsWith("banner-")) {
                        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[21/9] w-full bg-zinc-900 overflow-hidden", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: "absolute inset-0 w-full h-full bg-center bg-cover opacity-75",
                              style: {
                                backgroundImage: `url(${previewDevice === "mobile" ? sec.mobileImage : sec.desktopImage})`,
                                transform: `scale(${sec.scale || 1}) translate(${sec.xOffset || 0}%, ${sec.yOffset || 0}%)`,
                                transformOrigin: "center center"
                              }
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black via-black/30 to-transparent" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-x-0 bottom-0 p-4 space-y-1 z-10", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-md text-white font-bold leading-tight", children: sec.name || "Custom Banner" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-white text-black text-[8px] uppercase tracking-widest px-2.5 py-0.5 font-bold rounded-sm mt-0.5", children: "Explore" })
                          ] })
                        ] }, secId);
                      } else if (secId.startsWith("bucket-")) {
                        const bkt = state.buckets?.find((b) => b.id === sec.id);
                        if (!bkt) return null;
                        const starProd = productsList.find((p) => p.id === bkt.starProductId) || productsList.find((p) => bkt.productIds.includes(p.id));
                        const thumbnail = starProd?.image || "https://images.unsplash.com/photo-1539109136881-3be0616acf4b?auto=format&fit=crop&w=400&h=500&q=80";
                        const bktProducts = productsList.filter((p) => bkt.productIds.includes(p.id)).slice(0, 2);
                        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 space-y-3", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-white/5 pb-1 flex justify-between items-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] uppercase tracking-widest text-accent font-bold", children: [
                            "Bucket: ",
                            bkt.name
                          ] }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[21/9] rounded-xl overflow-hidden bg-zinc-900 border border-white/5", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: thumbnail, className: "absolute inset-0 w-full h-full object-cover opacity-60", alt: "" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/40 flex items-end p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-serif text-xs font-bold text-white uppercase", children: [
                              bkt.name,
                              " Star Fit"
                            ] }) })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: bktProducts.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: p.image, className: "aspect-[3/4] object-cover rounded-lg w-full", alt: "" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-semibold truncate", children: p.name })
                          ] }, p.id)) })
                        ] }, secId);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-4 h-4" }),
              " ",
              isAddingProduct ? "Collapse Form" : "Create Product"
            ]
          }
        )
      ] }),
      isAddingProduct && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-md p-4 overflow-y-auto animate-in fade-in duration-200", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-900 border border-amber-500/20 rounded-3xl p-6 md:p-8 max-w-5xl w-full max-h-[90vh] overflow-y-auto shadow-2xl shadow-amber-500/5 space-y-6 relative text-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              className: "absolute top-4 right-4 text-muted-foreground hover:text-white p-2 rounded-full hover:bg-white/10 transition-all cursor-pointer z-20",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-5 h-5" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-2xl text-amber-400 font-bold border-b border-white/5 pb-3", children: editingProduct ? "Edit Product" : "Publish New Product" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleProductSubmit, className: "space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6 text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] uppercase font-bold tracking-wider text-muted-foreground", children: "Product Name" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        required: true,
                        className: "w-full bg-surface border border-white/10 p-2.5 text-xs text-foreground rounded-lg outline-none focus:border-accent",
                        value: productForm.house || "",
                        onChange: (e) => setProductForm({ ...productForm, house: e.target.value })
                      }
                    )
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      placeholder: "e.g. T-Shirt, Hoodie, Gown",
                      className: "w-full bg-surface border border-white/10 p-2.5 text-xs text-foreground rounded-lg outline-none focus:border-accent",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border border-white/10 rounded-2xl bg-white/5 space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] uppercase tracking-wider text-accent font-bold", children: "SEO & Metadata Details" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] text-muted-foreground", children: "SEO Meta Title" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        placeholder: "e.g. Premium Silk Slip - Noir | ReeVibes",
                        className: "w-full bg-surface border border-white/10 p-2.5 text-xs text-foreground rounded-lg outline-none focus:border-accent",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] text-muted-foreground", children: "SEO Description" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "textarea",
                      {
                        rows: 2,
                        placeholder: "Compelling description for search engine result snippets...",
                        className: "w-full bg-surface border border-white/10 p-2.5 text-xs text-foreground rounded-lg outline-none focus:border-accent resize-none",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] text-muted-foreground", children: "Keywords (comma separated)" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                        placeholder: "e.g. silk, slip, dress, noir, luxury",
                        className: "w-full bg-surface border border-white/10 p-2.5 text-xs text-foreground rounded-lg outline-none focus:border-accent",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border border-white/10 rounded-2xl bg-white/5 space-y-4", children: [
                  ...
                  parseFloat(String(productForm.price || "").replace(/[^0-9.]/g, "")) < parseFloat(String(productForm.originalPrice || "").replace(/[^0-9.]/g, "")) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/5 pt-3 space-y-3 animate-in fade-in duration-200", children: [
                    ...
                    (productForm.discountBuyersCount || 0) > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[10px] text-muted-foreground italic", children: [
                      "Current buyers at discount: ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-bold", children: productForm.discountBuyersCount })
                    ] })
                  ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-3 pt-4 border-t border-white/5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "editorial-label bg-accent text-white px-6 py-2.5 hover:bg-accent/90 rounded-full cursor-pointer", children: editingProduct ? "Save Changes" : "Publish Product" })
            ] })
          ] })
        ] }),
        showCloseConfirm && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center bg-black/85 backdrop-blur-sm animate-in fade-in duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-zinc-950 border border-amber-500/20 p-6 rounded-2xl max-w-sm w-full text-center space-y-4 shadow-2xl", children: [
      ...
      (() => {
        ...
        if (searchTerm) {
          ...
          filtered = filtered.filter(
            (p) => p.name.toLowerCase().includes(term) || p.house.toLowerCase().includes(term) || p.sku && p.sku.toLowerCase().includes(term)
          );
        }
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3.5 bg-white/5 border border-white/10 rounded-2xl mb-6 text-xs backdrop-blur-md", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: filtered.map((p) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "liquid-glass liquid-glass-card-hover relative flex flex-col group overflow-hidden border border-white/5 rounded-2xl bg-white/[0.02]", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 right-3 z-20 flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[8px] font-bold uppercase tracking-wider px-2 py-0.5 rounded border border-white/10 ${isComplete ? "bg-blue-600/90 text-white shadow-lg shadow-blue-500/20" : "bg-yellow-500/95 text-black shadow-lg shadow-yellow-500/10"}`, children: isComplete ? "Complete" : "Incomplete" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `w-2.5 h-2.5 rounded-full border border-white/20 shadow-md ${isComplete ? "bg-blue-500 animate-pulse shadow-blue-500/80" : "bg-yellow-500 animate-pulse shadow-yellow-500/80"}`
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-[3/4] overflow-hidden bg-zinc-950 relative", children: [
                ...
                p.status && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `absolute bottom-3 right-3 text-[8px] uppercase tracking-widest font-mono font-bold px-2 py-0.5 rounded ${p.status === "PUBLISHED" ? "bg-emerald-500/80 text-white" : p.status === "HIDDEN" ? "bg-zinc-700/80 text-white" : "bg-amber-500/80 text-black"}`, children: p.status })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex-1 flex flex-col justify-between space-y-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-2 border-t border-white/5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground uppercase font-bold tracking-wider", children: "Workflow:" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "select",
                      {
                        value: p.status || "UNPUBLISHED",
                        onChange: (e) => {
                          updateProduct(p.id, { status: e.target.value });
                          toast.success(`Workflow status updated to ${e.target.value}`);
                        },
                        className: "bg-white/5 border border-white/10 hover:border-white/20 text-white rounded-lg text-[10px] px-2 py-1 outline-none cursor-pointer flex-1",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "UNPUBLISHED", children: "Unpublished" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "PUBLISHED", children: "Published (Live)" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "DRAFT", children: "Save as Draft" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "HIDDEN", children: "Hide (Private)" })
                        ]
                      }
                    )
                  ] }),
    ...
    tab === "orders" && /* @__PURE__ */ jsxRuntimeExports.jsxs(AdminCard, { className: "space-y-6 animate-in fade-in duration-200", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left border-collapse", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border-subtle text-sm", children: ordersList.map((o) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-surface-2/40", children: [
    ...
    tab === "customers" && /* @__PURE__ */ jsxRuntimeExports.jsxs(AdminCard, { className: "space-y-6 animate-in fade-in duration-200", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left border-collapse", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border-subtle text-muted-foreground text-xs uppercase tracking-widest", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "pb-3", children: "Status" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "pb-3 text-right", children: "Administrative" })
        ] }) }),
...
const Route$F = createFileRoute("/admin/top-16")({
...
const $$splitComponentImporter$C = () => import("./admin.sponsors-CeIoqfZo.mjs");
const Route$E = createFileRoute("/admin/sponsors")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$B = () => import("./admin.reports-Ddyo7RID.mjs");
const Route$D = createFileRoute("/admin/reports")({
  head: () => ({
    meta: [{
      title: "Reports — Admin"
    }]
...
const $$splitComponentImporter$A = () => import("./admin.photographers-BXeGiZ1c.mjs");
const Route$C = createFileRoute("/admin/photographers")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$z = () => import("./admin.open-contest-Di1mkLB1.mjs");
const Route$B = createFileRoute("/admin/open-contest")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$y = () => import("./admin.live-contest-Dmpv3grK.mjs");
const Route$A = createFileRoute("/admin/live-contest")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$x = () => import("./admin.contestants-xwltDZiZ.mjs");
const Route$z = createFileRoute("/admin/contestants")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$w = () => import("./admin.abuse-reports-ClEkmSU_.mjs");
const Route$y = createFileRoute("/admin/abuse-reports")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$v = () => import("../_shop.search-CuoSxpj_.mjs");
const searchParamsSchema = objectType({
  q: stringType().optional()
});
const Route$x = createFileRoute("/_shop/search")({
...
const $$splitComponentImporter$u = () => import("../_shop.register-DAxGN4Dn.mjs");
const Route$w = createFileRoute("/_shop/register")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$t = () => import("../_shop.login-qlUl7es8.mjs");
const Route$v = createFileRoute("/_shop/login")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$s = () => import("../_shop.categories-B4OG9ISe.mjs");
...
const Map = React2.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: containerRef, className: "w-full h-full rounded-2xl overflow-hidden relative border border-white/10 shadow-lg", children: mapInstance && /* @__PURE__ */ jsxRuntimeExports.jsx(MapContext.Provider, { value: { map: mapInstance }, children }) });
  }
);
Map.displayName = "Map";
function MapMarker({
  ...
  const handleReverseGeocode = async (lng, lat) => {
    try {
      ...
      if (data && data.address) {
        ...
        if (isEditingAddress) {
          if (street) setEditStreet(street);
          if (city) setEditCity(city);
          if (district) setEditDistrict(district);
          if (stateVal) setEditState(stateVal);
          if (pincode && pincode.replace(/\D/g, "").length === 6) {
            setEditPincode(pincode.replace(/\D/g, ""));
          }
        } else {
          if (street) setNewStreet(street);
          if (city) setNewCity(city);
          if (district) setNewDistrict(district);
          if (stateVal) setNewState(stateVal);
          if (pincode && pincode.replace(/\D/g, "").length === 6) {
            setNewPincode(pincode.replace(/\D/g, ""));
          }
        }
  ...
  const handleGeocodeActiveAddress = async () => {
    ...
    try {
      ...
      if (data && data[0]) {
        ...
        toast.error("Could not find the address on the map. Please pin manually.");
      }
    } catch (err) {
...
const $$splitComponentImporter$r = () => import("../_shop.account-Y0p_E259.mjs");
...
const $$splitComponentImporter$q = () => import("./FashionBattle.register-CmR7aKLY.mjs");
...
const $$splitComponentImporter$p = () => import("./FashionBattle.login-Dihpr7xB.mjs");
...
const $$splitComponentImporter$o = () => import("./FashionBattle.live-contest-BemA1ImN.mjs");
...
const $$splitComponentImporter$n = () => import("./FashionBattle.house-of-fashion-C-cOnYcH.mjs");
...
const $$splitComponentImporter$m = () => import("./FashionBattle.cart-CTiqsWgB.mjs");
...
const $$splitComponentImporter$l = () => import("./FashionBattle.best-photography-DpBulKF5.mjs");
...
const $$splitComponentImporter$j = () => import("./FashionBattle.angels-RZHD-IPY.mjs");
...
const $$splitComponentImporter$i = () => import("./FashionBattle.account-CkwuefTr.mjs");
...
const $$splitComponentImporter$h = () => import("./FashionBattle.about-bXX-08Zf.mjs");
...
const $$splitComponentImporter$g = () => import("./FashionBattle.apply.index--vO6BXku.mjs");
...
const $$splitComponentImporter$f = () => import("./FashionBattle.account.index-COOXQNGb.mjs");
...
const $$splitComponentImporter$e = () => import("../_shop.product._productId-DwlR-OPk.mjs");
const Route$f = createFileRoute("/_shop/product/$productId")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./FashionBattle.photography._photoId-B069MOGM.mjs");
...
const $$splitComponentImporter$c = () => import("./FashionBattle.live-contest._contestId-CJeDEb8C.mjs");
const $$splitNotFoundComponentImporter$2 = () => import("./FashionBattle.live-contest._contestId-D5C2SO_-.mjs");
...
const $$splitComponentImporter$b = () => import("./FashionBattle.house-of-fashion._productId-DObdJEJr.mjs");
const $$splitNotFoundComponentImporter$1 = () => import("./FashionBattle.house-of-fashion._productId-Dt9bjQmh.mjs");
...
const $$splitComponentImporter$a = () => import("./FashionBattle.contestants._slug-BTjXfs6r.mjs");
const $$splitNotFoundComponentImporter = () => import("./FashionBattle.contestants._slug-B7gw_wz0.mjs");
...
const $$splitComponentImporter$9 = () => import("./FashionBattle.contestant._contestantId-nip5zjoa.mjs");
const Route$a = createFileRoute("/FashionBattle/contestant/$contestantId")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./FashionBattle.apply._contestId-ToLcB6il.mjs");
...
const $$splitComponentImporter$7 = () => import("./FashionBattle.account.role-ratings-CQBRs0Td.mjs");
const Route$7 = createFileRoute("/FashionBattle/account/role-ratings")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./FashionBattle.account.role-judgements-DWMVYmHg.mjs");
const Route$6 = createFileRoute("/FashionBattle/account/role-judgements")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./FashionBattle.account.role-casting-CMJlq_bM.mjs");
const Route$5 = createFileRoute("/FashionBattle/account/role-casting")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./FashionBattle.account.role-applications-Bbybiox8.mjs");
const Route$4 = createFileRoute("/FashionBattle/account/role-applications")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./FashionBattle.account.profile-B7RX9eEh.mjs");
const Route$3 = createFileRoute("/FashionBattle/account/profile")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./FashionBattle.account.notifications-Bp7e2qTG.mjs");
const Route$2 = createFileRoute("/FashionBattle/account/notifications")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./FashionBattle.account.applications-DIkOuu7n.mjs");
const Route$1 = createFileRoute("/FashionBattle/account/applications")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./FashionBattle.live-contest._countryId._stage-C2Em97kc.mjs");
...
const ShopRoute = Route$P.update({
  id: "/_shop",
  getParentRoute: () => Route$R
});
...
const ShopIndexRoute = Route$N.update({
  id: "/",
  path: "/",
  getParentRoute: () => ShopRoute
});
const FashionBattleIndexRoute = Route$M.update({
  id: "/FashionBattle/",
  path: "/FashionBattle/",
  getParentRoute: () => Route$R
});
const ApiSponsorsRoute = Route$L.update({
  id: "/api/sponsors",
  path: "/api/sponsors",
  getParentRoute: () => Route$R
});
const ApiFlagsRoute = Route$K.update({
  id: "/api/flags",
  path: "/api/flags",
  getParentRoute: () => Route$R
});
const ApiCountriesLogosRoute = Route$J.update({
  id: "/api/countries-logos",
  path: "/api/countries-logos",
  getParentRoute: () => Route$R
});
const ApiAngelsRoute = Route$I.update({
  id: "/api/angels",
  path: "/api/angels",
  getParentRoute: () => Route$R
});
const AdminVoteControlRoute = Route$H.update({
...
const AdminTop16Route = Route$F.update({
  id: "/admin/top-16",
  path: "/admin/top-16",
  getParentRoute: () => Route$R
});
const AdminSponsorsRoute = Route$E.update({
  id: "/admin/sponsors",
  path: "/admin/sponsors",
  getParentRoute: () => Route$R
});
const AdminReportsRoute = Route$D.update({
  id: "/admin/reports",
  path: "/admin/reports",
  getParentRoute: () => Route$R
});
const AdminPhotographersRoute = Route$C.update({
  id: "/admin/photographers",
  path: "/admin/photographers",
  getParentRoute: () => Route$R
});
const AdminOpenContestRoute = Route$B.update({
  id: "/admin/open-contest",
  path: "/admin/open-contest",
  getParentRoute: () => Route$R
});
const AdminLiveContestRoute = Route$A.update({
  id: "/admin/live-contest",
  path: "/admin/live-contest",
  getParentRoute: () => Route$R
});
const AdminContestantsRoute = Route$z.update({
  id: "/admin/contestants",
  path: "/admin/contestants",
  getParentRoute: () => Route$R
});
const AdminAbuseReportsRoute = Route$y.update({
  id: "/admin/abuse-reports",
  path: "/admin/abuse-reports",
  getParentRoute: () => Route$R
});
const ShopSearchRoute = Route$x.update({
  id: "/search",
  path: "/search",
  getParentRoute: () => ShopRoute
});
const ShopRegisterRoute = Route$w.update({
  id: "/register",
  path: "/register",
  getParentRoute: () => ShopRoute
});
const ShopLoginRoute = Route$v.update({
  id: "/login",
  path: "/login",
  getParentRoute: () => ShopRoute
});
