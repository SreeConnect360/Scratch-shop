...
import { u as usePortal, r as Route$u, Q as QuickAddContext, P as PRODUCTS, i as useShopNotification } from "./_ssr/router-CgqY8r00.mjs";
import { t as toast } from "./_libs/sonner.mjs";
import "./_libs/maplibre-gl.mjs";
import { n as Sparkles, A as ArrowRight, S as Search, X, b as ChevronLeft, d as ChevronRight, a9 as Heart, f as ShoppingBag } from "./_libs/lucide-react.mjs";
...
function CategoryProductCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FadeUp, { delay: i % 6 * 0.05, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "liquid-glass liquid-glass-card-hover group flex flex-col justify-between h-full relative overflow-hidden bg-transparent border border-white/10 p-5 rounded-3xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "block flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-[3/4] overflow-hidden bg-zinc-950 relative rounded-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/product/$productId", params: {
          productId: p.id
        }, className: "block w-full h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: gallery[activeImgIdx], alt: p.name, className: "w-full h-full object-cover img-cinematic transition-transform duration-[1500ms] group-hover:scale-105" }) }),
        ...
        }, className: "absolute top-3 right-3 p-2 bg-black/60 backdrop-blur-md hover:bg-accent rounded-full transition-all cursor-pointer z-20 hover:scale-110 shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: `w-3.5 h-3.5 transition-colors ${isWishlisted ? "fill-rose-500 text-rose-500" : "text-white"}` }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/product/$productId", params: {
          productId: p.id
        }, className: "hover:text-accent transition-colors block mt-1", onMouseEnter: () => setIsTitleHovered(true), onMouseLeave: () => setIsTitleHovered(false), children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-sm mt-1 line-clamp-1 group-hover:text-accent transition-colors", children: p.name }) }),
    ...
    }, className: "mt-6 flex items-center justify-center gap-2 bg-foreground text-background py-3 text-xs uppercase tracking-widest font-bold hover:bg-accent hover:text-white transition-all duration-300 rounded-full cursor-pointer shadow-md", children: [
