...
const ListOrdered = createLucideIcon("list-ordered", __iconNode$N);
const __iconNode$M = [
...
const MessageCircleCode = createLucideIcon("message-circle-code", __iconNode$H);
const __iconNode$G = [
  [
    "path",
    {
