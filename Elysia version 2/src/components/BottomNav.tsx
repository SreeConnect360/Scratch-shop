...
/**
 * Mobile-only floating glass bottom navigation (hidden ≥768px). Search sits
 * center in a raised gold pearl; active tab tracked by scroll position and
 * marked with a gliding gold dot. Safe-area aware.
 */
export default function BottomNav() {
  ...
  return (
    ...
    >
      <div className="glass glass-strong glass-edge flex items-end justify-between rounded-[1.6rem] px-2 py-1.5">
          ...
          if (isSearch) {
            return (
              <button
                ...
                className="relative -mt-6 flex h-14 w-14 shrink-0 -translate-y-2 items-center justify-center rounded-full bg-gradient-to-br from-gold-soft via-gold to-gold-deep text-obsidian shadow-[0_10px_28px_-6px_rgba(200,169,106,0.7)] transition-transform duration-300 active:scale-90"
              >
